...
- Flag explicitly: don't scrape or store any community submission metadata (uploader
  credit, submission counts/variant numbers, etc., as seen in the reference image) — that
  belongs to whatever community site it came from and has no purpose in a personal, offline
  tool. Sprites and mechanics only.
...
- Community submission data (credit, variants, popularity) — not applicable to a personal tool
